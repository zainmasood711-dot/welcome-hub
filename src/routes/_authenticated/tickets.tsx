      ...
      <div className="space-y-4" dir="rtl">
        <Card>
          ...
          <CardContent className="grid grid-cols-1 gap-2 md:grid-cols-7">
            ...
            <Select value={typeFilter} onValueChange={setTypeFilter}><SelectTrigger><SelectValue placeholder="النوع" /></SelectTrigger><SelectContent><SelectItem value="all">كل الأنواع</SelectItem><SelectItem value="fault">عطل</SelectItem><SelectItem value="inquiry">استفسار</SelectItem><SelectItem value="preventive_maintenance">صيانة دورية</SelectItem><SelectItem value="new_installation">تركيب جديد</SelectItem></SelectContent></Select>
            <Select value={priorityFilter} onValueChange={setPriorityFilter}><SelectTrigger><SelectValue placeholder="الأولوية" /></SelectTrigger><SelectContent><SelectItem value="all">كل الأولويات</SelectItem><SelectItem value="low">منخفضة</SelectItem><SelectItem value="medium">متوسطة</SelectItem><SelectItem value="high">عالية</SelectItem><SelectItem value="critical">حرجة</SelectItem></SelectContent></Select>
            <Select value={engineerNeededFilter} onValueChange={setEngineerNeededFilter}><SelectTrigger><SelectValue placeholder="حاجة ميدانية" /></SelectTrigger><SelectContent><SelectItem value="all">الكل</SelectItem><SelectItem value="yes">تحتاج مهندس</SelectItem><SelectItem value="no">بدون مهندس</SelectItem></SelectContent></Select>
